...
const validate_jwt_middleware_1 = require("../../../middlewares/auth/validate-jwt.middleware");
...
const { getUserById, postUser, putUser, getUsers, getSqlPrueba, signIn } = userController;
router.post('/sign-in', signIn);
router.get('/get-all', getUsers);
router.get('/buscar/:id', getUserById);
router.post('/create', validate_jwt_middleware_1.validateJWT, postUser);
